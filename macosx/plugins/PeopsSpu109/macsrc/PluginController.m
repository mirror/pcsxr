...
void ReadConfig(void)
{
	...
	iUseXA = [[keyValues objectForKey:@"Enable XA"] boolValue];
	iXAPitch = [[keyValues objectForKey:@"XA Pitch"] boolValue];
	iUseDBufIrq = 1;//[[keyValues objectForKey:@"Decoded Buffer IRQ"] boolValue];
...
- (IBAction)ok:(id)sender
{
	...
	[writeDic setObject:[NSNumber numberWithInt:[xaEnableBox intValue]] forKey:@"Enable XA"];
...
- (void)loadValues
{
	...
	[xaEnableBox setIntValue:[[keyValues objectForKey:@"Enable XA"] intValue]];
